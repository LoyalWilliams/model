...
class MyProblem(ea.Problem):  # 继承Problem父类
    ...
    def aimFunc(self, pop):  # 目标函数
        ...
        models=[]
        best_index=0
        best_params={'max_depths':max_depths,'n_estimatorss':n_estimatorss,'min_child_weights':min_child_weights,'learning_rates':learning_rates
        ,'subsamples':subsamples,'colsample_bytrees':colsample_bytrees,'gammas':gammas,'reg_alphas':reg_alphas,'reg_lambdas':reg_lambdas}
